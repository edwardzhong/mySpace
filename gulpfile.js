...
gulp.task('less', function () {
    return watch('./public/less/*.less', function (){//watch less file,conver to css when less content change
...
gulp.task('rev', ["css","js","admin"],function () {
    return gulp.src(['./public/rev/**/*.json', './views/**/*.html'])//add md5 suffix to js and css file, replace the link of html as well 
        .pipe( revCollector({
            replaceReved: true,
            dirReplacements: {
                '/css': '/dist/css',
