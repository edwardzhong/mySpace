...
export class WriteMode extends Component{
	...
	render(){
		...
		let selArticle=Object.assign({},list.filter((item)=>item.isSelect)[0]||{
			id: -1,
			title: "无标题文章",
			content: "",
			is_publish:0,
		...
		return (
			<div className="write-mode">
				<aside className="aside">
					...
					<a className="btn" href="/">回首页</a>
					</div>
					<ul className="notes-list">
						<li className="active"><a href="javascript:;"><i className="fa fa-book"></i> 文章</a></li>
						<li><Link to="/trash"><i className="fa fa-trash-o"></i> 回收站</Link></li>
					</ul>
				</aside>
				<div className="middle">
					<a onClick={()=>this.createNewArticle()} id="addArticle" href="javascript:;" className="add-article"><i className="fa fa-plus-circle"></i> 新建文章</a>
					...
					/>
					<ArticleMenu menuOption={menuOption}
						hideMenu={hideMenu} 
